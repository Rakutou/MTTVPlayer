...
let albumData = [
    AlbumModel(title:"LEFT TO OUR OWN DEVICES",image:UIImage(named:"album1"),songurl:NSBundle.mainBundle().URLForResource("song1", withExtension: "mp3")!),
    AlbumModel(title:"ANDREW MCMAHON IN THE WILDERNESS",image:UIImage(named:"album2"),songurl:NSBundle.mainBundle().URLForResource("song2", withExtension: "mp3")!),
    AlbumModel(title:"CONTRAST",image:UIImage(named:"album3"),songurl:NSBundle.mainBundle().URLForResource("song3", withExtension: "mp3")!),
    AlbumModel(title:"GLASS BOYS",image:UIImage(named:"album4"),songurl:NSBundle.mainBundle().URLForResource("song4", withExtension: "mp3")!),
    AlbumModel(title:"HOW TO RUN AWAY",image:UIImage(named:"album5"),songurl:NSBundle.mainBundle().URLForResource("song5", withExtension: "mp3")!),
    AlbumModel(title:"LA BRONZE",image:UIImage(named:"album6"),songurl:NSBundle.mainBundle().URLForResource("song6", withExtension: "mp3")!),
    AlbumModel(title:"PEOPLE UNDER THE STAIRS",image:UIImage(named:"album7"),songurl:NSBundle.mainBundle().URLForResource("song7", withExtension: "mp3")!),
    AlbumModel(title:"POEMSS",image:UIImage(named:"album8"),songurl:NSBundle.mainBundle().URLForResource("song8", withExtension: "mp3")!),
    AlbumModel(title:"SWIM TEAM",image:UIImage(named:"album9"),songurl:NSBundle.mainBundle().URLForResource("song9", withExtension: "mp3")!),
    AlbumModel(title:"THE PAINS OF BEING PURE AT HEART",image:UIImage(named:"album10"),songurl:NSBundle.mainBundle().URLForResource("song10", withExtension: "mp3")!)
]
...
class ViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        //self.view.backgroundColor = UIColor(patternImage: UIImage(named: "tvBG")!)
    ...
    //MARK:Make the Interface Landscape
    ...
    //MARK:Add the title Label & 滑动效果的开始效果
    ...
    //MARK:PlayReachEnd Notification
    ...
    func updateTimetoTimeMarker(){
        ...
        secondObserver = player.addPeriodicTimeObserverForInterval(CMTimeMake(60,60), queue: nil) { (time:CMTime) -> Void in
            ...
            //var value1 = Double(Double((self.player.currentItem?.currentTime().value)!)/1000000000)
        ...
        //滑块观察
        sliderObserver = player.addPeriodicTimeObserverForInterval(CMTimeMake(60,10000), queue: nil) { (time:CMTime) -> Void in
